...
export default function HeroContent() {
  return (
    <div className="flex h-full flex-col justify-center">
      ...
      <button className="mt-10 inline-flex w-fit items-center gap-2 rounded-full bg-cyan-400 px-8 py-4 font-semibold text-slate-950 transition hover:bg-cyan-300 hover:scale-[1.02]">
        {hero.button}
